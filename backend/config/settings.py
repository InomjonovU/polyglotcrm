...
MIDDLEWARE = [
    ...
    # WhiteNoise — production'da Django static fayllarni o'zi servis qiladi (admin CSS uchun)
    ...
    'apps.users.middleware.LoginAttemptMiddleware',
]
...
# Production xavfsizlik — DEBUG=False bo'lganda kuchayadi
if not DEBUG:
...
# Center
CENTER_NAME = config('CENTER_NAME', default='PolyglotLC')
CENTER_URL = config('CENTER_URL', default='http://localhost:5173')
