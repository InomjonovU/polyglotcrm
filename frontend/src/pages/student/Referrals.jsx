...
export default function StudentReferrals() {
  ...
  const { data: referrals, isLoading } = useQuery({
    ...
    queryFn: () => api.get('/students/', { params: { referrer_student: me.id } }).then(r => r.data),
    enabled: !!me?.id,
  })
      ...
      <div className="card">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-10 text-ink-500">
            ...
            Hozircha referrallar yo'q. Do'stlaringizni taklif qiling!
          </div>
        ) : (
          <table className="table-clean">
            <thead><tr><th>Ism</th><th>Holat</th><th>Qo'shilgan sana</th></tr></thead>
            <tbody>
              {rows.map(r => (
                <tr key={r.id}>
